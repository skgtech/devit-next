...
import royal from './../public/venues/royal_theatre.jpg';
import city from './../public/venues/citycollege.jpg';
...
const Venue = ({ name, venueFor, desc, lat, long, src, switchOrder }) => {
  return (
    <div className="venue">
      <div
        css={{
